<div class="row m0 p10" style="padding-top: 0px;padding-right:0px">
        ...
        <form class="form-inline" action="{{asset('b/bills/search/')}}" method="get">
            <div class="row m0">
                ...
                <div class="col-md-3 input-group" style="display: inline-flex">
                    <input autocomplete="off" value="{{isset($_GET['q']) ? $_GET['q']:''}}" name="q" required style="width: 100%;" placeholder="Tìm kiếm theo mã, tên bệnh nhân"  type="text" class="form-control">
